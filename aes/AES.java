public class AES {
    ...
    public static int[][] g(int[][] word, int col, int i) {
        ...
        return xor(tempword, getCol(roundConstant, i));
    }

    public static int[][] copyValues(int[][] mat1, int[][] mat2, int j1, int j2) {
        for (int i = 0; i < mat1.length; i++) {
    ...
    public static void main(String[] args) {
        int mainkey[][] = { { 0x2b, 0x28, 0xab, 0x9 }, { 0x7e, 0xae, 0xf7, 0xcf }, { 0x15, 0xd2, 0x15, 0x4f },
                { 0x16, 0xa6, 0x88, 0x3c } };
        int word[][] = new int[4][44];
        copyValues(word, mainkey, 0, 4);
